...
input_train_pos = os.path.join(train_data, "pmts_pos.csv")
input_train_s_hits = os.path.join(train_data, "spmt_hits.h5")
input_train_l_hits = os.path.join(train_data, "lpmt_hits.h5")
input_train_true_info = os.path.join(train_data, "true_info.csv")
#input_train_list = glob.glob(os.path.join(train_data, "/*.csv"))
input_test_l_hits = os.path.join(input_dir, "test_l_hits.h5)
input_test_s_hits = os.path.join(input_dir, "test_s_hits.h5)   
